...
I specialize in building and scaling product engineering teams that deliver AI-powered fintech platforms. With over a decade of hands-on experience across organizations such as IBM, ICICI, TATA AIG, and TATA-AIA, I have successfully led cross-functional engineering teams through complex initiatives — ranging from cloud-native payment systems and SaaS platforms to AI-driven solutions in Forex, remittance, lending, insurance, and digital commerce

What I bring to the table:
→ Product Engineering Leadership — I architect, coach, and grow high-performing teams across UI, Backend, QA, DevOps, and Data Engineering. I've taken products from 0→1 and scaled them through rapid growth.
